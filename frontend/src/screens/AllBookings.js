                ...
                <Fragment>
                    {isLoading ? <Loader /> : (
                        <div className="w-[80%] sm:w-[60%] md:w-[70%] mx-auto mt-3">
                            <h2 className="text-2xl font-medium text-center my-8">Tất cả lịch đặt phòng</h2>
                                ...
                                <div className="p-5">
                                    ...
                                    <DialogActions className="mt-4">
                                        ...
                                        <button
                                            ...
                                            onClick={editHandler} className=" border-red-400 text-red-400 hover:text-red-500 hover:border-red-500 hover:bg-red-200 border-solid border py-2 rounded-lg w-24 text-center transition duration-200 box-border">Cập nhật</button>
                                    </DialogActions>
                                </div>
                            </Dialog>
                        </div>
